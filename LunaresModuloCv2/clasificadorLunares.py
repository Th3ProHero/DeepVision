...
@author: franciscorealescastro & Mau
"""

import cv2
import numpy as np

img=cv2.imread('F:/OpenCV/datasetLunares/dysplasticNevi/train/dysplasticNevi5.jpg')
...
paths=[r'F:/OpenCV/datasetLunares/dysplasticNevi/train/',
       r'F:/OpenCV/datasetLunares/spitzNevus/train/'
       ]
...
path_img='F:/OpenCV/datasetLunares/dysplasticNevi/train/dysplasticNevi5.jpg'
